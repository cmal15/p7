...
public class Listas{
    ...
    protected Computadora(LinkedList<Smartphone> smartphones,LinkedList<Tablet> tablets,LinkedList<Television> televisiones,LinkedList<Laptop> laptops,LinkedList<PC> pcs){
